const questions = [
  ...
  '나는 남에게 질문을 들었을 때',
  '나는 어떤 모임에 참석했을 때',
  '남들과 뮤지컬을 함께 만든다면', // I/E Questions

  '나 자신이 가치 있다고 느낄 때는',
  '나는 보고서를 쓸 때 주로',
  '나는 남을 평가할 때',
  '내가 걱정을 하는 이유는 주로',
  '과제나 업무에 대한 지시는', // N/S Questions

  '남을 평가할때 더 중요한 것은',
  '남의 문제를 해결해 줄 때, 더 흥미를 느끼는 쪽은',
  '나는 대화를 할 때',
  '내가 더 능력을 발휘하는 환경은',
  '피드백을 받을 때 듣고싶은 말은', //F/T Questions
...
const answers = [
  ...
  '상상력과 감수성이 뛰어난 것을 확인할 때',
  '판단력과 분석력이 뛰어난 것을 확인할 때', // N/S Question 1

  '새로운 아이디어 위주로 보고한다',
  '구체적이고 명확한 수치를 보고한다', // N/S Question 2
  ...
  '사람 보는 눈을 가진 몇몇 사람의 분석',
  '최대한 많은 사람들의 종합적인 의견', // F/T Question 1

  '어떤 선물을 고를까 하는 고민',
  '부당한 핸드폰 요금 청구', // F/T Question 2

  '결론을 쉽게 내리지 않는다',
  '논리적이고 단정적으로 말한다', // F/T Question 3

  '협력하여 무엇을 이루어 내려는 분위기',
  '선의의 경쟁을 하는 분위기', // F/T Question 4

  '고생했어. 정말 열심히 하더라',
  '잘했어. 조금만 수정하면 완벽하겠다', // F/T Question 5
